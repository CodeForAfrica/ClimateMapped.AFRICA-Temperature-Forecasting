...
# Title
st.title("Country Level Temperature Forecasting")
...
year_range = st.slider('Select the range of years for prediction', min_value=2025, max_value=2030, value=(2025, 2030))
