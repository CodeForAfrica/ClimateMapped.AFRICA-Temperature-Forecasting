...
if selected_countries:
    ...
    # Convert the selected forecasted data to CSV
    ...
    st.download_button(
        ...
        data=csv_data,
        file_name='forecasted_temperature.csv',
        mime='text/csv'
    )
    ...
    st.plotly_chart(fig)
#===========================================================================================================================================
#st.write("Upload a CSV file with monthly temperature data for different countries to forecast 27-years temperatures.")
